...
struct AppDestinationMenu: View {
    ...
    var body: some View {
        Menu {
            ...
            // 17 pt semibold + 36 pt height, matching the approved compact
            // Agents title: `.plain` keeps the system's default large-title
            // button chrome (background, pressed highlight) out of the way
            // so all three pages render the same inset.
            HStack(spacing: 7) {
